...
class Br {
  ...
  read() {
    let len = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.buf.length;
  ...
  readUInt64BEBn() {
    ...
    const bn = new _bn.Bn().fromBuffer(buf);
    this.pos = this.pos + 8;
    return bn;
  }
  ...
  readVarIntBn() {
    ...
    switch (first) {
      case 0xfd:
        return new _bn.Bn(this.readUInt16LE());

      case 0xfe:
        return new _bn.Bn(this.readUInt32LE());

      case 0xff:
        return this.readUInt64LEBn();

      default:
        return new _bn.Bn(first);
    }
  }
