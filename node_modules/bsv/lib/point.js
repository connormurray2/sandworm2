...
const ec = _bitcoinElliptic.default.curves.secp256k1;
...
class Point extends _Point {
  ...
  getX() {
    ...
    const x = Object.create(_bn.Bn.prototype);
  ...
  getY() {
    ...
    const y = Object.create(_bn.Bn.prototype);
  ...
  fromJSON(json) {
    const x = new _bn.Bn().fromString(json.x);
    const y = new _bn.Bn().fromString(json.y);
  ...
  static getN() {
    return new _bn.Bn(ec.curve.n.toArray());
