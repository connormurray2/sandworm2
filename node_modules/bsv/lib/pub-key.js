...
class PubKey extends _struct.Struct {
  ...
  fromPrivKey(privKey) {
    this.fromObject({
      point: _point.Point.getG().mul(privKey.bn),
  ...
  async asyncFromPrivKey(privKey) {
    const workersResult = await _workers.Workers.asyncObjectMethod(this, 'fromPrivKey', [privKey]);
  ...
  async asyncFromBuffer(buf, strict) {
    ...
    const workersResult = await _workers.Workers.asyncObjectMethod(this, 'fromBuffer', args);
    return this.fromFastBuffer(workersResult.resbuf);
  }
  ...
  fromDer(buf, strict) {
    ...
    if (buf[0] === 0x04 || !strict && (buf[0] === 0x06 || buf[0] === 0x07)) {
      ...
      const x = new _bn.Bn(xbuf);
      const y = new _bn.Bn(ybuf);
      this.point = new _point.Point(x, y);
  ...
  fromX(odd, x) {
    ...
    this.point = _point.Point.fromX(odd, x);
    return this;
  }
  ...
  validate() {
    ...
    if (this.point.eq(new _point.Point(new _bn.Bn(0), new _bn.Bn(0)))) {
