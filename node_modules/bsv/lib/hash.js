...
Hash.asyncSha1 = async function (buf) {
  const args = [buf];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'sha1', args);
...
Hash.sha256 = function (buf) {
  ...
  const Sha256 = _hash.default.sha256;
...
Hash.asyncSha256 = async function (buf) {
  const args = [buf];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'sha256', args);
  return workersResult.resbuf;
};
...
Hash.asyncSha256Sha256 = async function (buf) {
  const args = [buf];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'sha256Sha256', args);
  return workersResult.resbuf;
};
...
Hash.ripemd160 = function (buf) {
  ...
  const Ripemd160 = _hash.default.ripemd160;
...
Hash.asyncRipemd160 = async function (buf) {
  const args = [buf];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'ripemd160', args);
  return workersResult.resbuf;
};
...
Hash.asyncSha256Ripemd160 = async function (buf) {
  const args = [buf];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'sha256Ripemd160', args);
  return workersResult.resbuf;
};
...
Hash.sha512 = function (buf) {
  ...
  const Sha512 = _hash.default.sha512;
...
Hash.asyncSha512 = async function (buf) {
  const args = [buf];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'sha512', args);
  return workersResult.resbuf;
};
...
Hash.asyncSha1Hmac = async function (data, key) {
  const args = [data, key];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'sha1Hmac', args);
  return workersResult.resbuf;
};
...
Hash.asyncSha256Hmac = async function (data, key) {
  const args = [data, key];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'sha256Hmac', args);
  return workersResult.resbuf;
};
...
Hash.asyncSha512Hmac = async function (data, key) {
  const args = [data, key];
  const workersResult = await _workers.Workers.asyncClassMethod(Hash, 'sha512Hmac', args);
  return workersResult.resbuf;
};
