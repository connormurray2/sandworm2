...
/**
   ...
   */
class Sig extends _struct.Struct {
  ...
  fromRS(rsbuf) {
    ...
    this.r = new _bn.Bn().fromBuffer(b2);
    this.s = new _bn.Bn().fromBuffer(b3);
    return this;
  }
  ...
  static parseDer(buf, strict) {
    ...
    const r = new _bn.Bn().fromBuffer(rbuf);
    ...
    const s = new _bn.Bn().fromBuffer(sbuf);
  ...
  hasLowS() {
    if (this.s.lt(1) || this.s.gt(_bn.Bn.fromBuffer(Buffer.from('7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF5D576E7357A4501DDFE92F46681B20A0', 'hex')))) {
      return false;
    }
