...
class TxIn extends _struct.Struct {
  constructor(txHashBuf, txOutNum, scriptVi, script) {
    let nSequence = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0xffffffff;
    super({
      txHashBuf,
      txOutNum,
      scriptVi,
  ...
  fromJSON(json) {
    this.fromObject({
      ...
      scriptVi: typeof json.scriptVi !== 'undefined' ? _varInt.VarInt.fromJSON(json.scriptVi) : undefined,
      script: typeof json.script !== 'undefined' ? _script.Script.fromJSON(json.script) : undefined,
  ...
  fromBr(br) {
    ...
    this.scriptVi = _varInt.VarInt.fromBuffer(br.readVarIntBuf());
    this.script = _script.Script.fromBuffer(br.read(this.scriptVi.toNumber()));
  ...
  fromPubKeyHashTxOut(txHashBuf, txOutNum, txOut) {
    let pubKey = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : new _script.Script().writeOpCode(_opCode.OpCode.OP_0);
    const script = new _script.Script();

    if (txOut.script.isPubKeyHashOut()) {
      script.writeOpCode(_opCode.OpCode.OP_0); // blank signature
