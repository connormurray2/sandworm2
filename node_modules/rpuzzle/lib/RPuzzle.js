const Signature = require('bsv').Sig;
const ECDSA = require('bsv').Ecdsa;
const BN = require('bsv').Bn;
const Opcode = require('bsv').OpCode;
const PrivateKey = require('bsv').PrivKey;
const PublicKey = require('bsv').PubKey;
//const HDPrivateKey = require('bsv').HDPrivateKey;
const HDPrivateKey = null
//const HDPublicKey = require('bsv').HDPrivateKey;
const HDPublicKey = null
const Transaction = require('bsv').Tx;
const Script = require('bsv').Script;
const Hash = require('bsv').Hash;
